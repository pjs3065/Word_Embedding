...
class DepCNNv6(object):
    ...
    #num_classes -> 클래스(타입) 종류, vocab_size -> 총 어절 수, pos_size -> 총 pos 사이즈, hc_size -> 총 hc 사이즈
    def __init__( self, num_classes, vocab_size, pos_size, hc_size, embedding_size, mlp_size, l2_reg_lambda=0.0):
        ...
        # Embedding layer
        with tf.device('/cpu:0'), tf.name_scope("embedding"): # 영역의 이름을 embedding으로 지정
