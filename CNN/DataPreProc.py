...
def convert_to_input_vector(sample_batch, model):
    ...
    for sample in sample_batch:
        ...
        x_position_batch.append(model.position_mark) # 이걸 왜 넣는 거지?
...
class Sentence:
    ...
    def add_dependency(self, line):
        ...
        for mor in mor_list:
            ...
            new_mor = Morpheme()
            new_mor.pos = mor[idx + 1:] # 남/NNP 에서 NNP를 new_mor.pos에 저장
            new_mor.lex = mor[:idx] #'남'을 lexical 저장
            eoj.morpheme_list.append(new_mor) #어절 저장
